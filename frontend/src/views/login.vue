<template>
  <div class="container mx-auto flex h-screen">
    <div class="m-auto size-auto space-y-3 rounded-xl bg-gray-200 p-7 shadow-lg">
      ...
      <div class="space-y-3">
        <input type="text" placeholder="Username" class="input block w-full text-center" v-model="username" required />
        <input type="password" placeholder="Password" class="input block w-full text-center" v-model="password" />
